...
`bg-blue-400`인 div에 hover했을 때, 하위 자식 div도 색상을 변경하는 방법 👉🏻 <mark>**`group`**</mark>
...
<img src='/images/content/tailwind-tricks/1.png' alt='' />
...
<img src='/images/content/tailwind-tricks/2.png' alt='' />

형제 요소의 색상을 변경하는 방법 👉🏻 <mark>**`peer`**</mark>
...
<img src='/images/content/tailwind-tricks/3.png' alt='' />
### Extend Tailwind
