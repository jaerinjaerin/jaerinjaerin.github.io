---
title: 'CSS 기초 정리하기'
description: 'CSS의 기본 문법, 박스 모델, 셀렉터에 대한 기초 정리'
date: '2023-02-15'
tags: ['CSS']
featured: false
...
웹 페이지 스타일 및 레이아웃을 정의하는 스타일 시트이다.
...
![CLI 인터페이스](/images/content/css-basics/1.png)
...
![페이지 예시](/images/content/css-basics/2.png)
...
![스타일 적용 결과](/images/content/css-basics/3.png)

---

## CSS 문법 이해하기

![CSS 문법](/images/content/css-basics/4.png)

<Callout type="info">
**CSS 기본 구조**

- **셀렉터**: 요소 이름이나 id, 또는 클래스를 선택
- **속성**: 색상, 글자 크기 등 다양한 속성
- **값**: 속성에 적용할 적절한 값
- **세미콜론(;)**: 속성과 값의 끝에 붙여 속성끼리 구분
...
CSS에서 사용하는 상대 길이 단위이다. **상대 길이 단위**는 상위요소의 글꼴 크기 또는 viewport 크기와 관련이 있다.
...
![박스 모델 예시](/images/content/css-basics/5.png)
...
| width, height 사용 가능 여부 | 가능  | 불가능               | 가능                 |

### 박스를 구성하는 요소

![박스 모델 구조](/images/content/css-basics/6.png)
...
- `overflow: hidden` - 넘치는 내용을 보여주고 싶지 않을 때
...
![box-sizing 적용 결과](/images/content/css-basics/7.png)
