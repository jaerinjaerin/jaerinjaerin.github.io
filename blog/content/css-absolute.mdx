---
title: 'absolute 요소 중앙정렬'
description: 'position: absolute를 이용해 요소를 중앙정렬하는 방법'
date: '2023-11-24'
tags: ['CSS']
featured: false
...
- left:50%만큼 이동시키면 absolute의 요소 시작지점을 기준으로 containing block의 50%만큼 이동한다. 👉🏻 <mark>이때 사용하는 것이 transform 속성</mark>

  <img src='/images/content/css-absolute/1.png' alt='' />
...
<img src='/images/content/css-absolute/2.png' alt='' />
